var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            description: 'A magnitude 9 earthquake orginiating at the Cascadia Subduction Zone would cause destruction across the Pacific Northwest. The Oregon Department of Geology and Mineral Industries has <a href="https://www.multco.us/em/dogami-study-estimates-cascadia-earthquake-impacts-portland-region">estimated</a> it could result in $37 billion in damages, displace 85,000 people, and than cause 27,000 casualties, ranging from minor injuries to deaths. About 150 miles east from the fault line, in the city of Portland, the worst shaking will likely be along the banks of the Willamette River, where peak ground velocity could reach 44 centimeters per second, liquifying the soil.',
            location: {
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            description: "Sitting above this liquifaction zone is Oregon's Critical Energy Infrastructure Hub, which houses 630 tanks that store a variety of fuel and hazardous material. A 2020 study estimates that under the conditions caused by a megathrust earthquake, 397 of those tanks would fail, releasing between 94.6 million and 193.7 million gallons of gasoline, crude oil, and other toxic liquids into the ground and the Willamette River.",
            location: {
                center: [-122.75195, 45.55684],
                zoom: 13,
                pitch: 0,
